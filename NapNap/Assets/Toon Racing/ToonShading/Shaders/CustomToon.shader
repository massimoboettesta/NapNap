...
Shader "Toon/CustomToon"
{
	Properties
	{
		...
		[ASEEnd][ASEBegin]_TextureSample("Texture Sample", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( ( float4( bakedGI21 , 0.0 ) * tex2DNode7 ) + ( ( tex2DNode7 * float4( staticSwitch18 , 0.0 ) ) * SampleGradient( gradient5, ( (dotResult3*0.5 + 0.5) * max( max( temp_output_12_0.x , 0.0 ) , 0.0 ) ) ) ) ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18500
0;294;1168;584;2065.18;670.2126;3.017958;True;False
...
Node;AmplifyShaderEditor.SamplerNode;7;-34.79224,-191.6612;Inherit;True;Property;_TextureSample;Texture Sample;0;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=2E3789C04BD50E6E1E717A36A2A87A7C325E4DF3